...
key <- "ko83b1Wv63QzhQgb4jhZbJR4fFwnwThtPk6vCMGoEaySpidtpOw4axEyYG6rjNj8ei1XLbgXW/DWaPXVg=="

# Creates a container named 'test'
azureBlobCall("https://psbu20180215.blob.core.windows.net/test?restype=container", "PUT", key)

# Creates a blob named 'blob.txt' under container 'test' with the content of "Hello, Cummins!"
azureBlobCall("https://psbu20180215.blob.core.windows.net/test/blob.txt", "PUT", key, 
              headers = c("x-ms-blob-type"="BlockBlob"), requestBody = "Hello, Cummins!")

# Read the blobl named 'blob.txt' 
azureBlobCall("https://psbu20180215.blob.core.windows.net/test/blob.txt", "GET", key)
